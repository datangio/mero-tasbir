    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="max-h-[90vh] w-full max-w-4xl mx-4 sm:mx-0 overflow-y-auto rounded-2xl bg-white shadow-2xl"
        ...
        >
          ...
          <div className="p-4 sm:p-6">
            ...
            {/* Navigation */}
            <div className="mt-6 sm:mt-8 flex items-center justify-between border-t border-gray-200 pt-4 sm:pt-6">
              <button
                onClick={step === 1 ? onClose : onPrev}
                className="text-sm sm:text-base text-gray-500 transition-colors hover:text-gray-700"
              >
                {step === 1 ? "Cancel" : "← Back"}
              </button>
              ...
              {step !== 3 && (
                <motion.button
                  ...
                  onClick={onNext}
                  disabled={!canProceed}
                  className={`rounded-xl px-4 sm:px-6 lg:px-8 py-2 sm:py-3 font-semibold transition-all duration-300 text-sm sm:text-base ${
                    canProceed
...
const BookingStep1: React.FC<BookingStep1Props> = ({
  ...
  return (
    ...
    >
      <h2 className="mb-4 text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <motion.button
          ...
          className={`rounded-xl border-2 p-4 sm:p-6 lg:p-8 transition-all duration-300 ${
      ...
      <div className="mx-auto max-w-md space-y-4 sm:space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-300 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base focus:border-transparent focus:ring-2 focus:ring-purple-500"
